...
entity ParamEst_NN_linear_ap_fixed_ap_fixed_16_6_4_0_0_PARAMEST_NN_linear_config10_s is
port (
...
architecture behav of ParamEst_NN_linear_ap_fixed_ap_fixed_16_6_4_0_0_PARAMEST_NN_linear_config10_s is 
...
begin
    ...
    ap_return_11 <= data_12_val;
    ap_return_12 <= data_13_val;
    ap_return_13 <= data_14_val;
    ap_return_14 <= data_15_val;
    ap_return_15 <= data_16_val;
    ap_return_16 <= data_17_val;
    ap_return_17 <= data_18_val;
    ap_return_18 <= data_19_val;
    ap_return_19 <= data_20_val;
    ap_return_2 <= data_2_val;
    ap_return_20 <= data_21_val;
    ap_return_21 <= data_22_val;
    ap_return_22 <= data_23_val;
    ap_return_23 <= data_24_val;
    ap_return_24 <= data_25_val;
    ap_return_25 <= data_26_val;
    ap_return_26 <= data_27_val;
    ap_return_27 <= data_28_val;
    ap_return_28 <= data_29_val;
    ap_return_29 <= data_30_val;
    ap_return_3 <= data_3_val;
    ap_return_30 <= data_31_val;
